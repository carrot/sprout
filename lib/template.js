        ...
        function () {
          ...
          return new Promise(
            ...
            function (result) {
              ...
              /*
               * Write or copies all files with our Utils class.
               */
              ...
              return Promise.map(files,
                function (file) {
                  ...
                  if (helpers.isBinaryFile(file.fullPath)) {
                    ...
                    /*
                     * If the file is a binary, copy it.
                     */

                    self.emitter.emit('msg', 'copying ' + file.fullPath);
                    return utils.copy(file.fullPath, file.path);
