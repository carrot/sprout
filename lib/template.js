      ...
      return this.update().then(
        ...
        function () {
          ...
          if (_.isFunction(options.questionnaire) && _.isObject(init.configure)) {
            return options.questionnaire(init.configure, _.keys(locals));
          }
        ...
        function () {
          ...
          if (init.beforeRender) {
            return new Promise(
              function (resolve, reject) {
                return init.beforeRender(config, resolve, reject);
              }
            )
          }
        ...
        function () {
          ...
          if (init.after) {
            return new Promise(
              function (resolve, reject) {
                return init.after(config, resolve, reject);
              }
            )
          }
