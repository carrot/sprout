...
var readdirp = Promise.promisify(require('readdirp'))
  ...
  Template.prototype = {
        ...
        function () {
          ...
          return new Promise(
            function (resolve, reject) {
              ...
              if (!fs.existsSync(path.join(self.path, 'init.js')) && !fs.existsSync(path.join(self.path, 'init.coffee'))) {
        ...
        function () {
          ...
          return new Promise(
            function (resolve, reject) {
              ...
              var initJS = path.join(self.path, 'init.js')
              var initPath
    ...
    update: function () {
      ...
      return new Promise(
        ...
        return exec('git remote', { cwd: self.path }).then(function (stdout) {
          var origin
          if (stdout[0]) {
    ...
    run: function (target, generator, args) {
      ...
      return new Promise(
        function (resolve, reject) {
          ...
          var generatorJs = path.join(self.generators, generator + '.js')
          var generatorPath
    ...
    remove: function () {
      ...
      return new Promise(
        function (resolve, reject) {
          ...
          var lstat = fs.lstatSync(self.path)
