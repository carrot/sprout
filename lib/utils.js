...
module.exports = (function () {
  ...
  var Utils = function (src, target) {
    ...
    /*
     * Copy a directory from one path relative to the src, to another relative to the target
     * @param {String} from - the path to copy from, relative to the src.
     * @param {String} to - the path to copy to.
     * @return {Promise} - promise to copy
     */
    this.copyDir = function (from, to) {
      return copyDir(path.resolve(self._src, from), path.resolve(self._target, to));
    }
