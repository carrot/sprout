...
/**
 * register the handlebars-helpers library of utilities, as well as any helpers
 * that the user passed in the configuration.
 * @param  {Object} helpers - helpers config, key is the name, value is the fn
 */
function registerHandelbarsHelpers (helpers) {
